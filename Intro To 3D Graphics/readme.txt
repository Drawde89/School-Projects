...
(j) Model a human character with no arms. (4 Marks).
(k) The character should move in the x and y world directions. (2 Marks).
(l) The legs of the character should kick (hips, knees) as shown in the video. (4
Marks). The feet do not move.
(m) You do not have to match the exact motion or dimensions of the objects shown in
the sample executable. However, your scene and the sample one should be
qualitatively and visually similar (4 Marks).
(n) Programming style (comments, functions) (2 Marks).
